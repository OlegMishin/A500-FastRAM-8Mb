...
"E:\openocd-v0.11.0\bin\openocd.exe" -f "E:\openocd-v0.11.0\scripts\interface\altera-usb-blaster.cfg" -c init -c "svf 8MB_fastram_1502qfpV1.svf" -c "sleep 200" -c shutdown
pause